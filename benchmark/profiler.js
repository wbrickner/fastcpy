...
async function init() {
	...
	await Promise.all([
		writeFile("./results/memcpy-results.csv", make_csv(memcpy_benchmark_results), "utf8"),
		writeFile("./results/fastcpy-results.csv", make_csv(fastcpy_benchmark_results), "utf8")
	])
}
